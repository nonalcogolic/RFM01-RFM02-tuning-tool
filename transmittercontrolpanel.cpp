...
#include "Commands/Transmitter/hwreset.h"
   ...
   , mTransmitterHandler(mPinout)
{
   ...
   connect(ui->but_reset, SIGNAL(clicked()), this, SLOT(sendHWReset()));
...
void TransmitterControlPanel::sendHWReset()
{
   NTransmitter::HWReset msg;
   send(msg);
}
